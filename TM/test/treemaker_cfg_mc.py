...
process.demo = cms.EDAnalyzer('TM',
                              ...
                              fillpfjetInfo_       = cms.untracked.bool(False),
                              #jetCorrectorLabel_   = cms.untracked.InputTag("AK4PFchs"),
                              pfjetLabel_          = cms.untracked.InputTag("slimmedJets"),
                              filljetInfo_       = cms.untracked.bool(True),
                              svLabel_             = cms.untracked.InputTag("slimmedSecondaryVertices"),
                              jetLabel_          = cms.untracked.InputTag("selectedUpdatedPatJetsNewDFTraining"),
